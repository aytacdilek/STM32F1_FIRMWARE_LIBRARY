...
#define SD_CS_PIN                     GPIO_Pin_4					/* PB.5 */
#define SD_CS_GPIO_PORT               GPIOA							/* GPIOB */
#define SD_CS_GPIO_CLK                RCC_APB2Periph_GPIOA



#define SD_BLOCK_SIZE    0x200			// Block Size

#define SD_DUMMY_BYTE   0xFF			// Dummy byte
